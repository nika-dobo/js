...
console.log("sum: " + (str + str2 + num6));// ეს არის მათემატიკური ოპერაცია რომელიც გვაძლევს შედეგს და აერთიანებს სტრინგებს
...
if(num7 > 5){// ეს არის პირობითი ოპერაცია რომელიც გვაძლევს შედეგს თუ პირობა შესრულდა
    console.log("true");// ეს არის პირობითი ოპერაცია რომელიც გვაძლევს შედეგს თუ პირობა შესრულდა
}
else if(num7 == 5){// ეს არის პირობითი ოპერაცია რომელიც გვაძლევს შედეგს თუ პირობა შესრულდა
...
if (num7 > 5 || ishashous == true) {// ეს არის პირობითი ოპერაცია რომელიც გვაძლევს შედეგს თუ პირობა შესრულდა
    console.log("true");// ეს არის პირობითი ოპერაცია რომელიც გვაძლევს შედეგს თუ პირობა შესრულდა
}
...
var arr2 = [[1,2,3],[4,5,6],[7,8,9]];// ეს არის მრავალგანზომილებიანი მასივი რომელიც შეიცავს მონაცემებს list-ის სახით
...
console.log(15 != 15.000000000000001)